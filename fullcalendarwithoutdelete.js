 ...
 * FullCalendar 
 ...
 // Hier ist die JS datei für den Benutzer ohne Bearbeitungsrechte also ohne löschen/delete
 */
   ...
   console.log(jsonArray);
    ...
    $.ajax({
        ...
        success: function (response) {
            console.log("gesendet json: \n");
            console.log(response);

        },
        error: function (response) {
            console.log("fehler beim senden zu json \n");
            console.log(response);
        }
    });
