...
<!--Funktioniert ohne Mailserver nicht aber COde ist richtig-->
<?php 
$showForm = true;
...
für deinen Account auf www.maybecoaching.de wurde nach einem neuen Passwort gefragt. Um ein neues Passwort zu vergeben, rufe innerhalb der nächsten 24 Stunden die folgende Website auf:
'.$url_passwortcode.'
