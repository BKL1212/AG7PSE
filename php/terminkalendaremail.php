...
$empfaenger = "barkin44@hotmail.de"; //Empfänger-Adresse
$mail_cc = ""; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
$betreff = "Neue Kontaktanfrage"; //Betreff der Email
 
$url_ok = "http://www.maybe-coaching.de/ok"; //Zielseite, wenn E-Mail erfolgreich versendet wurde
$url_fehler = "http://www.maybe-coaching.de/fehler"; //Zielseite, wenn E-Mail nicht gesendet werden konnte
