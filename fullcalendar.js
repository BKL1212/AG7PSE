...
HIER IST DAS JS VOM KALENDER TEMPLATE --> VON MIR WURDE LÖSCHEN; BEARBEITEN; SPEICHERN HINZUGEFÜGT
...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    ([
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var EventApi = /** @class */ (function () {
                ...
                EventApi.prototype.setProp = function (name, val) {
                    ...
                    if (name.match(/^(start|end|date|allDay)$/)) {
                        ...
                        if (name === 'editable') {
                            ...
                            props = {
                                classNames: html_1.parseClassName(val)
                            };
                        } else {
                ...
                Object.defineProperty(EventApi.prototype, "durationEditable", {
                    get: function () {
                        return this.def.durationEditable;
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Object.defineProperty(EventApi.prototype, "backgroundColor", {
                    get: function () {
                        return this.def.backgroundColor;
                    },
                    enumerable: true,
                    configurable: true
                });
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var DateComponent = /** @class */ (function (_super) {
                ...
                DateComponent.prototype.renderByFlag = function (renderState, flags) {
                    var _a = this,
                        renderedFlags = _a.renderedFlags,
                        dirtySizeFlags = _a.dirtySizeFlags;
                    if (flags.skeleton) {
                        this.renderSkeleton();
        ...
        (function (module, exports, __webpack_require__) {
            ...
            function isSelectionValid(selection, calendar) {
                return isEntitiesValid([{
                    ...
                    overlap: null,
                    allow: null
                }], normalizeConstraint(calendar.opt('selectConstraint'), calendar), calendar.opt('selectOverlap'), calendar.opt('selectAllow'), calendar);
            }
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var View = /** @class */ (function (_super) {
                ...
                View.prototype.computeTitle = function (dateProfile) {
                    ...
                    return dateEnv.formatRange(range.start, range.end, formatting_1.createFormatter(this.opt('titleFormat') || this.computeTitleFormat(dateProfile), this.opt('titleRangeSeparator')), {
        ...
        (function (module, exports, __webpack_require__) {
            ...
            */
            ...
            function buildDateSpanApi(span, dateEnv) {
                ...
                props.startStr = dateEnv.formatIso(span.range.start, {
                    omitTime: span.allDay
                });
                props.endStr = dateEnv.formatIso(span.range.end, {
                    omitTime: span.allDay
                });
                return props;
            }
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var DateProfileGenerator = /** @class */ (function () {
                ...
                DateProfileGenerator.prototype.getFallbackDuration = function () {
                    return duration_1.createDuration({
                        day: 1
                    });
                };
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var DAY_NUM_FORMAT = formatting_1.createFormatter({
                day: 'numeric'
            });
            var WEEK_NUM_FORMAT = formatting_1.createFormatter({
                week: 'numeric'
            });
            ...
            var DayGrid = /** @class */ (function (_super) {
                ...
                DayGrid.prototype.queryHit = function (leftOffset, topOffset) {
                    var _a = this,
                        ...
                        offsetTracker = _a.offsetTracker;
                        ...
                        for (i = 0; i < levelSegs.length; i++) {
                            ...
                            if (totalSegsBelow) { // do we need to replace this segment with one or many "more" links?
                                ...
                                for (j = 0; j < colSegsBelow.length; j++) {
                                    moreTd = dom_manip_1.createElement('td', {
                ...
                DayGrid.prototype.renderMoreLink = function (row, col, hiddenSegs) {
                    ...
                    var view = this.view;
                    var dateEnv = this.getDateEnv();
                    var a = dom_manip_1.createElement('a', {
                        className: 'fc-more'
                    });
                    ...
                    for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
                        ...
                        if (slicedRange) {
                            newSegs.push(object_1.assignTo({}, seg, {
                                eventRange: {
                                    def: eventRange.def,
                                    ui: object_1.assignTo({}, eventRange.ui, {
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var BasicView = /** @class */ (function (_super) {
                ...
                BasicView.prototype.renderSkeleton = function () {
                    ...
                    dayGridEl = dom_manip_1.createElement('div', {
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var WEEK_HEADER_FORMAT = formatting_1.createFormatter({
                week: 'short'
            });
            ...
            var AgendaView = /** @class */ (function (_super) {
                ...
                AgendaView.prototype.renderSkeleton = function () {
                    ...
                    timeGridEl = dom_manip_1.createElement('div', {
                            ...
                            view.buildGotoAnchorHtml( // aside from link, important for matchCellWidths
                                {
                                    ...
                                    type: 'week',
                                    forceOff: this.colCnt > 1
                                }, html_1.htmlEscape(weekText) // inner HTML
                            ) +
                            '</th>';
                    } else {
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var TimeGrid = /** @class */ (function (_super) {
                ...
                TimeGrid.prototype.renderNowIndicator = function (date) {
                    ...
                    for (i = 0; i < segs.length; i++) {
                        var lineEl = dom_manip_1.createElement('div', {
                    ...
                    if (segs.length > 0) { // is the current time in view?
                        var arrowEl = dom_manip_1.createElement('div', {
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var DayGridEventRenderer = /** @class */ (function (_super) {
                    ...
                    for (i = 0; i < levelCnt; i++) { // iterate through all levels
                        ...
                        if (levelSegs) {
                            for (j = 0; j < levelSegs.length; j++) { // iterate through segments in level
                                ...
                                td = dom_manip_1.createElement('td', {
                ...
                DayGridEventRenderer.prototype.fgSegHtml = function (seg) {
                    ...
                    titleHtml =
                        '<span onclick="deleteEvent(this, ' + eventDef.defId + ')" class="fc-title">' +
                    ...
                    return dom_manip_1.createElement('tr', {
                        ...
                        (mainFormat ?
                            this.buildGotoAnchorHtml(dayDate, {
                                ...
                                }, html_1.htmlEscape(dateEnv.format(dayDate, mainFormat)) // inner HTML
                            ) :
                            '') +
                        (altFormat ?
                            this.buildGotoAnchorHtml(dayDate, {
                                    'class': 'fc-list-heading-alt'
                                }, html_1.htmlEscape(dateEnv.format(dayDate, altFormat)) // inner HTML
                            ) :
                            '') +
                        '</td>');
                };
        ...
        (function (module, exports, __webpack_require__) {
            ...
            */
            ...
            function computeEventForDateSpan(dateSpan, dragMeta, calendar) {
                ...
                var instance = event_1.createEventInstance(def.defId, {
                    start: start,
                    end: end
                });
                return {
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var Calendar = /** @class */ (function () {
                ...
                Calendar.prototype.renderSkeleton = function () {
                    var _this = this;
                    dom_manip_1.prependToElement(this.el, this.contentEl = dom_manip_1.createElement('div', {
                ...
                */
                ...
                Calendar.prototype.renderView = function (forceFlags) {
                    ...
                    if (!renderedView.el) {
                        renderedView.setElement(dom_manip_1.createElement('div', {
                            className: 'fc-view fc-' + renderedView.type + '-view'
                        }));
                    } else {
                ...
                Calendar.prototype.renderToolbars = function (forceFlags) {
                    ...
                    if (headerLayout) {
                        ...
                        this.header.render(object_1.assignTo({
                            layout: headerLayout
                        }, props), forceFlags);
                    }
                    ...
                    if (footerLayout) {
                        ...
                        this.footer.render(object_1.assignTo({
                            layout: footerLayout
                        }, props), forceFlags);
                    }
                };
                ...
                Calendar.prototype.select = function (dateOrObj, endDate) {
                    ...
                    var selection = date_span_1.parseDateSpan(selectionInput, this.dateEnv, duration_1.createDuration({
                            days: 1
                        }) // TODO: cache this?
                    );
                ...
                Calendar.prototype.triggerDayClick = function (dateSpan, dayEl, view, ev) {
                    this.publiclyTrigger('dateClick', [{
                        ...
                        dateStr: this.dateEnv.formatIso(dateSpan.range.start, {
                            omitTime: dateSpan.allDay
                        }),
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var Toolbar = /** @class */ (function (_super) {
                ...
                function Toolbar(calendar, extraClassName) {
                    ...
                    _this.el = null;
                    _this.calendar = calendar;
                    _this.setElement(dom_manip_1.createElement('div', {
                ...
                Toolbar.prototype.renderSection = function (position, buttonStr) {
                    ...
                    var sectionEl = dom_manip_1.createElement('div', {
                ...
                TimeGridEventRenderer.prototype.fgSegHtml = function (seg) {
                    ...
                    return '<a class="' + classes.join(' ') + '"' +
                        ...
                        (timeText ?
                            ...
                            '') +
                        (eventDef.title ?
                            '<div onclick="deleteEvent(this)" class="fc-title">' +
        ...
        (function (module, exports, __webpack_require__) {
            ...
            var DayGridFillRenderer = /** @class */ (function (_super) {
                ...
                DayGridFillRenderer.prototype.renderFillRow = function (type, seg) {
                    ...
                    if (startCol > 0) {
                        trEl.appendChild(dom_manip_1.createElement('td', {
                            colSpan: startCol
                        }));
                    }
            ...
            var DayTile = /** @class */ (function (_super) {
                ...
                DayTile.prototype.renderSkeleton = function () {
                    ...
                    this.el.innerHTML =
                        ...
                        '<span onclick="deleteEvent(this)" class="fc-title">' +
                    ...
                    if (geom_1.pointInsideRect({
                        ...
                        return {
                            ...
                            dateSpan: {
                                ...
                                range: {
                                    start: this.date,
                                    end: marker_1.addDays(this.date, 1)
                                }
                            },
                            dayEl: this.el,
                            rect: rect,
                    ...
                    if (anyValid) {
                        return {
                            ...
                            duration: (props.startTime && props.endTime) ?
                                duration_1.subtractDurations(props.endTime, props.startTime) : null,
...
function createJsonArray(eventArray) {

    var count = Object.keys(eventArray["instances"]).length;

    jsonArray = new Array(count);
    ...
    //push defs objects into jsonArray
    for (let index = 0; index < count * 2; index++) {
        ...
        var myObj = {
            title: eventArray["defs"][index].title,
            allDay: eventArray["defs"][index].allDay,
            backgroundColor: eventArray["defs"][index].backgroundColor,
            borderColor: eventArray["defs"][index].borderColor,
            classNames: eventArray["defs"][index].classNames,
            constraint: eventArray["defs"][index].constraint,
            defId: eventArray["defs"][index].defId,
            durationEditable: eventArray["defs"][index].durationEditable,
            extendedProps: eventArray["defs"][index].extendedProps,
            groupId: eventArray["defs"][index].groupId,
            hasEnd: eventArray["defs"][index].hasEnd,
            overlap: eventArray["defs"][index].overlap,
            publicId: eventArray["defs"][index].publicId,
            rendering: eventArray["defs"][index].rendering,
            sourceId: eventArray["defs"][index].sourceId,
            startEditable: eventArray["defs"][index].startEditable,
            textColor: eventArray["defs"][index].textColor,
            title: eventArray["defs"][index].title,
            url: eventArray["defs"][index].url,
            forcedEndTzo: null,
            forcedStartTzo: null,
            instanceId: null,
            start: null,
        ...
        jsonArray[index / 2] = myObj;
    }

    //push instances obj into jsonArray
    for (let index = 1; index <= count * 2; index++) {
        if (index % 2 == 0) {
            continue;
        }

        arrayIndex = Math.floor((index / 2) - 1) + 1;

        jsonArray[arrayIndex].forcedEndTzo = eventArray["instances"][index].forcedEndTzo;
        jsonArray[arrayIndex].forcedStartTzo = eventArray["instances"][index].forcedStartTzo;
        jsonArray[arrayIndex].instanceId = eventArray["instances"][index].instanceId;
        jsonArray[arrayIndex].start = eventArray["instances"][index].range.start;
        jsonArray[arrayIndex].end = eventArray["instances"][index].range.end;
    }
    ...
    console.log(eventArray["instances"]);
...
function deleteEvent(htmlEvent, id) {

    if (confirm("Diesen Eintrag löschen?")) {
        console.log("Deleting: " + htmlEvent.innerHTML + " with defId: " + id);
        ...
        $.ajax({
            ...
            data: {
                delete: true,
                title: htmlEvent.innerHTML,
                defId: id
            },
            success: function (response) {
                console.log("sent eventData to deleteEvent.php");
                console.log(response);
                htmlEvent.remove();

            },
            error: function (response) {
                console.log("ERROR: failed to send eventData to deleteEvent.php");
                console.log(response);
